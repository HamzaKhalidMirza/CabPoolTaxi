...
export class HomePage implements OnInit, OnDestroy {
  ...
  pickupLocation() {
    this.openLocationPickerModal('Pickup')
      .subscribe(location => {
        ...
        if(!this.endLocation) {
          ...
          let directionsDisplay = new googleMapsSk.DirectionsRenderer({map: map});
          this.directionsDisplay = directionsDisplay;
          
          var start = new googleMapsSk.LatLng(this.startLocation.lat, this.startLocation.lng);
          var end = new googleMapsSk.LatLng(this.endLocation.lat, this.endLocation.lng);  
  ...
  dropoffLocation() {
    this.openLocationPickerModal('Dropoff')
      .subscribe(location => {
